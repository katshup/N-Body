...
public class CompassMode extends Activity implements SensorEventListener,
		LocationListener {
	// this compass works by comparing the orientation of the phone to the
	// orientation
	// of magnetic north
	float azimut;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		provider = LocationManager.NETWORK_PROVIDER; // a general area is good
														// enough so we can just
														// use the network
														// provider
		...
		if (location != null) {
			...
			// url =
			// "http://api.openweathermap.org/data/2.5/weather?lat="+String.valueOf(lat)+"&lon="+String.valueOf(lng)+"&APPID=19c8a9b7048067ba61114a1cb00e992e";
		} else {
